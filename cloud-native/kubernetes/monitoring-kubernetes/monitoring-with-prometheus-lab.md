...
[Gathering metrics with Prometheus lab Introduction Video](youtube:qnDzZ2eOy0E)
...
2.  Let's check that Prometheus is scraping some data. Click in the **Expression** box the press the space bar
